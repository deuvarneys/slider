...
var Range = function (_React$Component) {
  ...
  Range.prototype.onMoveByKeyboard = function onMoveByKeyboard(position, step) {
    ...
    var closestBound = this.getClosestBound(this.calcValueByPos(position));
    var boundNeedMoving = this.getBoundNeedMoving(props.value, closestBound);

    var oldValue = state.bounds[boundNeedMoving];
    var value = oldValue + step;

    var nextBounds = [].concat(_toConsumableArray(state.bounds));
    nextBounds[boundNeedMoving] = value;

    var nextHandle = boundNeedMoving;
  ...
  Range.prototype.moveToMin = function moveToMin(position) {
    ...
    var min = _props3.min;
    var pushable = _props3.pushable;
    var allowCross = _props3.allowCross;
  ...
  Range.prototype.render = function render() {
    ...
    var min = _props4.min;
    var max = _props4.max;
    var _props4$ariaLabel = _props4.ariaLabel;
    var ariaLabel = _props4$ariaLabel === undefined ? [] : _props4$ariaLabel;
    var _props4$ariaValueNow = _props4.ariaValueNow;
    var ariaValueNow = _props4$ariaValueNow === undefined ? [] : _props4$ariaValueNow;
    var _props4$ariaValueText = _props4.ariaValueText;
    var ariaValueText = _props4$ariaValueText === undefined ? [] : _props4$ariaValueText;
    var _props4$ariaValueMin = _props4.ariaValueMin;
    var ariaValueMin = _props4$ariaValueMin === undefined ? [] : _props4$ariaValueMin;
    var _props4$ariaValueMax = _props4.ariaValueMax;
    var ariaValueMax = _props4$ariaValueMax === undefined ? [] : _props4$ariaValueMax;
    var handleGenerator = _props4.handle;
...
Range.propTypes = {
  ...
  ariaLabel: _react.PropTypes.arrayOf(_react.PropTypes.string),
  ariaValueNow: _react.PropTypes.arrayOf(_react.PropTypes.string),
  ariaValueText: _react.PropTypes.arrayOf(_react.PropTypes.string),
  ariaValueMin: _react.PropTypes.arrayOf(_react.PropTypes.number),
  ariaValueMax: _react.PropTypes.arrayOf(_react.PropTypes.number)
};
Range.defaultProps = {
  count: 1,
  allowCross: true,
