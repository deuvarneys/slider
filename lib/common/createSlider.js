...
function createSlider(Component) {
  ...
  return _temp = _class = function (_Component) {
    ...
    ComponentEnhancer.prototype.render = function render() {
      ...
      var maximumTrackTintColor = _props3.maximumTrackTintColor;
      var style = _props3.style;

      var _Component$prototype$ = _Component.prototype.render.call(this);

      var tracks = _Component$prototype$.tracks;
      var handles = _Component$prototype$.handles;
    ...
    handle: function handle(_ref) {
      ...
      var restProps = _objectWithoutProperties(_ref, ['index']);
